# sigvcf/modules/juridico/services.py
...
from sigvcf.core.domain.models import ReporteIncumplimiento
...
class JuridicoService:
    ...
    def calcular_penalizacion_por_atraso(self, orden_id: int) -> PenalizacionDTO:
        ...
        Esta es una simulación y la lógica real dependería de las cláusulas del contrato.
        """
        with self.uow:
    ...
    def listar_incumplimientos_pendientes(self) -> List[ReporteIncumplimientoDTO]:
        ...
        """
        with self.uow:
            # Se asume que cualquier estado que no sea 'RESUELTO' está pendiente.
            todos_los_reportes = self.uow.reportes_incumplimiento.list()
            reportes_pendientes = [r for r in todos_los_reportes if r.estado != 'RESUELTO']
