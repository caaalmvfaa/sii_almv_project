...
from sigvcf.modules.administrativo.dto import ContratoDTO, OrdenCompraDTO, ArticuloContratoDTO
...
class AdministrativoService:
    ...
    def crear_o_actualizar_contrato(self, contrato_dto: ContratoDTO) -> ContratoDTO:
        ...
        """
        with self.uow:
            proveedor = self.uow.proveedores.get(contrato_dto.proveedor_id)
            if not proveedor:
            ...
            if contrato_dto.id:
                ...
                # Actualizar campos del contrato
                ...
                # Actualizar artículos (estrategia simple: borrar y recrear)
                contrato.articulos.clear()
            else:
                contrato = Contrato()
            ...
            # Devolver el DTO actualizado con el ID y los artículos
    ...
    def listar_ordenes_pendientes(self) -> List[OrdenCompraDTO]:
        """
